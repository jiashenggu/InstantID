...
if __name__ == "__main__":
    ...
    base_model_path = "/ML-A100/team/mm/gujiasheng/sd_webui_0/models/Stable-diffusion/LahHongchenSDXLSD15_sdxlV10"
    ...
    face_image = load_image("./examples/kaifu_resize.png")
