...
styles = [
    {
        "name": "Modern",
        "prompt": "masterpiece, {prompt}, upper body, focus, jewelry, parted lips, shirt, modern background, black hair, multicolored hair",
    ...
    {
        "name": "Dramatic",
        "prompt": "masterpiece, best quality, ultra-detailed, dramatic expression, {prompt}, hair between eyes, long hair, open mouth, ring,  jacket, shirt, glowing eyes, tiny blood",
        "negative_prompt": "nsfw, longbody, lowres, bad anatomy, bad hands, missing fingers, pubic hair,extra digit, fewer digits, cropped, worst quality, low quality"
    },
    {
        "name": "Japanese Anime Style",
        "prompt": "2d anime, japanese anime style, head portrait, {prompt}, closed mouth, skirt, necklace, simple background",
        "negative_prompt": "nsfw, photorealistic, longbody, lowres, bad anatomy, bad hands, missing fingers, pubic hair,extra digit, fewer digits, cropped, worst quality, low quality"
    },
    {
        "name": "Japanese Anime Style 2",
        "prompt": "2d anime, japanese anime style, school uniform, {prompt}, outdoors, sky, simple background, upper body",
        "negative_prompt": "nsfw, photorealistic, longbody, lowres, bad anatomy, bad hands, missing fingers, pubic hair,extra digit, fewer digits, cropped, worst quality, low quality"
    },
    {
        "name": "Realistic",
        "prompt": "masterpiece, 2.5d, beautiful, {prompt}, photorealistic, unreal engine, shirt, looking at viewer, earrings, smile, hair between eyes, crop top, short hair, close-up",
        "negative_prompt": "nsfw, anime, cartoon, longbody, lowres, bad anatomy, bad hands, missing fingers, pubic hair,extra digit, fewer digits, cropped, worst quality, low quality"
    },
    {
    ...
    {
        "name": "Mona Anime",  # Peter Pan proposed
        "prompt": "japanese anime, High saturation, colorful, Makoto Shinkai style, masterpiece, best quality, beautiful, 4k, intricate detail, {prompt}",
    ...
    },
    {
        ...
        # "negative_prompt": "black and white, ugly, deformed, noisy, blurry, low contrast, color, realism, photorealistic"
        "prompt": "silhouette style {prompt} . colorful, high contrast, minimalistic, stark, dramatic",
        "negative_prompt": "black and white, ugly, deformed, noisy, blurry, low contrast, realism, photorealistic"
    },
    {
...
image_to_image_styles = {normalize_key(k['name']): (k['prompt'], k['negative_prompt']) for k in image_to_image_styles}


def apply_style(style: str,
                positive: str,
                personality_trait_tags: list[str] | None = None):
    p, n = styles.get(style, (positive, ""))
    return p.replace('{prompt}', positive), n


def apply_image_to_image_style(style: str,
                               positive: str):
    p, n = image_to_image_styles.get(style, (positive, ""))
    return p.replace('{prompt}', positive), n